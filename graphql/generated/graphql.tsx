...
export type CreateAlbumMutation = { __typename?: 'Mutation', createAlbum: { __typename?: 'Album', id: string, title: string } };
...
export const PhotosDocument = gql`
    query Photos($where: WherePhotoInput, $orderBy: PhotoOrderBy) {
  photos(where: $where, orderBy: $orderBy) {
    id
    media {
      id
      url
